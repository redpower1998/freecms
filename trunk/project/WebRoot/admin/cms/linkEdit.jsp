				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
          		<input type="text" id="ordernum" value="${link.ordernum }" name="link.ordernum" onkeyup=if(isNaN(value))execCommand('undo') onafterpaste=if(isNaN(value))execCommand('undo') class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
							</TD>
						</TR>
					</TBODY>
				</TABLE>
