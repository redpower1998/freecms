	...
	<ul id="mixedpar" >
			<s:iterator value="siteList" status="bean">
				<li id="<s:property value="id"/>" class="hasChildren">
					<span><font size="2">
					<a href="site_edit.do?site.id=<s:property value="id"/>" target="infoFrame"><b><s:property value="name"/></b></a></font>
					</span>
					<ul>
						<li><span  >&nbsp;</span></li>
					</ul>
      ...
      <iframe width="100%" height="450" name="infoFrame" id="infoFrame" framespacing="0" border="false"  frameborder="0"></iframe>
