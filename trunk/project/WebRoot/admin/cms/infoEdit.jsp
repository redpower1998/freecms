...
<HTML>
	...
	<script src="../../js/jquery.treeview.async.js" type="text/javascript"></script>
		...
		<script type="text/javascript" src="../../js/ckfinderUtil.js"></script>

	</HEAD>
	<BODY>
		<FORM id=MyForm 
			method=post name=MyForm action=info_editDo.do>
			<input type="hidden" name="pageFuncId" value="${pageFuncId }"/>
					...
					<TBODY>
						...
						<TR>
							<TD width="70%" align="left"  colspan="10">
								...
								<ckfinder:setupCKEditor   basePath = "/freecms/admin/ckfinder/"   editor = "editor1"   />   
								<ckeditor:replace   replace = "editor1"   basePath = "/freecms/admin/ckeditor/"   />    
