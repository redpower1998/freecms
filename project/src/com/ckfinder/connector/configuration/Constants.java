...
public class Constants {
	 ...
	 */
	public static final String CKFINDER_REGEX_IMAGES_EXT =
										"([^\\.]+(\\.(?i)(jpg|png|gif|bmp))$)";

	/**
	 * regular expression for invalid chars in file name.
	 */
	public static final String INVALID_FILE_NAME_REGEX
												= "\\p{Cntrl}|[/\\:\\*\\?\"\\<\\>\\|]";
	 ...
	 * regular expression for invalid chars in file name.
	 */
	public static final String INVALID_PATH_REGEX
									= "(/\\.|\\p{Cntrl}|//|\\\\|[:*?<>\"\\|])";
	...
	public static class Errors {
		...
		public static final int CKFINDER_CONNECTOR_ERROR_SOURCE_AND_TARGET_PATH_EQUAL
																				= 118;
		...
		public static final int CKFINDER_CONNECTOR_ERROR_UPLOADED_INVALID_NAME_RENAMED
																				= 207;
