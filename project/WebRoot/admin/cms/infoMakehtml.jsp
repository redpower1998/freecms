...
<HTML>
	...
	<BODY>
			...
			<input type="hidden" name="info.id" value="${info.id }"/>
				...
				<input type="checkbox" name="htmlChannelOld" value="1" />原所属栏目页面静态化<br/>
				</s:if>
				...
				<input type="button" value="不，我要继续添加信息" onclick="location.href='info_list.do?inf.channel=${info.channel }&pageFuncId=${pageFuncId }'"  class="button"  />
				</s:if>
				<s:if test='%{"channel"!=type}'>
