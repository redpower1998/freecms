...
insert  into `freecms_func`(`id`,`name`,`isOk`,`orderNum`,`url`,`parId`) values ('969d27f9-71f8-4cb8-a1bd-6343fe32bbb1','评论管理','1',12,'cms/comment_list.do','');
...
insert  into `freecms_member`(`id`,`grouptype`,`groupid`,`loginname`,`name`,`pwd`,`sex`,`birthday`,`tel`,`mobilephone`,`email`,`isOk`,`lastLoginTime`,`addtime`,`intro`,`credit`,`experience`,`img`) values ('9d68fe58-d57a-48c4-b09d-4ae6702fee36',0,'2751da4b-4a05-40ac-b7e2-eec21c33aa4b','b',NULL,'92eb5ffee6ae2fec3ad71c777531578f',NULL,NULL,NULL,NULL,'b@b.com','1',NULL,'2013-02-04 15:00:05',NULL,0,0,NULL);
